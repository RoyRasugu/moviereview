...
class ReviewTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_review = Review(1234,'Review for movies',"https://image.tmdb.org/t/p/w500/jdjdjdjn",'This movie is the best thing since sliced bread')
    ...
    def test_check_instance_variables(self):
        ...
        self.assertEquals(self.new_review.imageurl,"https://image.tmdb.org/t/p/w500/jdjdjdn")
